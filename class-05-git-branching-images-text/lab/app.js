...
function sum(a, b) { //eslint-disable-line
    var summed = a + b;
    var result = [summed, "The sum of " + a +  " and " + b + " is " + summed + "."];
    return result;
...
function multiply(a, b) { //eslint-disable-line
    var multiplied = a * b;
    var result = [multiplied, "The product of " + a +  " and " + b + " is " + multiplied + "."];
    return result;
}
...
function multiplyArray(multArr) { //eslint-disable-line
    var multiplyArrayVal = multiply(multArr[0], multArr[1])[0];
    multiplyArrayVal = multiply(multiplyArrayVal, multArr[2])[0];
    // console.log(multiplyArrayVal);
    var stringMultiplyArray = "The numbers " + multArr[0] + "," + multArr[1] + "," + multArr[2] + " have a product of " + multiplyArrayVal + "."
    // console.log(stringMultiplyArray);
    var result = [multiplyArrayVal, stringMultiplyArray];
    return result;
}
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
    var multVal = 1;
    var stringMultVal = "The numbers "; 
    var comma = ",";
    var i = 0;
    for (i = 0; i < dynamicArray.length; i++) {
        var multVal = multiply(multVal, dynamicArray[i])[0];
        if (i === dynamicArray.length - 1) {
            comma = ""; 
        }
        stringMultVal = stringMultVal + dynamicArray[i] + comma;
    }
    stringMultVal = stringMultVal + " have a product of " + multVal + "."
    // console.log(multVal);
    // console.log(stringMultVal);
    
    var result = [multVal, stringMultVal];
    return result;
}
